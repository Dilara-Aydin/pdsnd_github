...
def get_filters():
    ...
    while True:    
        month = input("Select a month to filter by: January, February, March, April, May, June or choose option 'all' if you have no preference").lower()
    ...
    while True:
        day = input("Select a day to filter by: Sunday, Monday, Tuesday, Wednesday, Thursday, Friday, Saturday, or choose option 'all' if you have no preference").lower()
